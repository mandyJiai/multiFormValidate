(function ($) {
    ...
    $.fn.extend({
        validate: function () {
            ...
            $(validator.currentForm).find("[macco-type='submit']").each(function(index){
                $(this).click(function(){
                    var pointFrom = $(this).attr("macco-point-form");
                    var errorArray = new Array();              
                    if(pointFrom==undefined||pointFrom==""){
                        return false;
                    }else{
                        $(pointFrom).find("[macco-vail-input='true']").each(function(index){
                            var element = $(this);
                            if (document.all) {
                                // 如果浏览器是IE
    ...
    $.extend($.validator, {
        prototype: {
            ...
            divType:function(){
                var isInput= $(this.currentForm).is("input");
                if(isInput){
                    var input = $(this.currentForm);
                    this.singularInput(input);
                }else{
            ...
            singularInput:function(input){
                var isvalid = input.attr("macco-vail-input");
                if(isvalid=="true"){
                    var element = input;
                    console.log(element);
                    if (document.all) {
            ...
            eachInput: function (form) {              
                form.find("[macco-vail-input='true']").each(function (index) {
                    var element = $(this);
                    if (document.all) {
                        // 如果浏览器是IE
                        $.validator.log();
